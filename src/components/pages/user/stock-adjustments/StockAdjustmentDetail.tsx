...
import {
    ...
    ArrowUpCircle, ArrowDownCircle, Link2, History, CheckCircle2, XCircle,
} from "lucide-react";
        ...
        <div className="flex flex-col px-4 pb-6 gap-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col gap-0.5">
                    <h1 className="text-lg font-semibold text-foreground">Stock Adjustment Detail</h1>
                    <span className="text-xs text-muted-foreground">Stock In / Stock Out</span>
                </div>
            </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex flex-col gap-0.5">
                                ...
                                <span className="text-xs text-muted-foreground">
                                    {new Date(detail.adjustment_date).toLocaleDateString("vi-VN", { day: "2-digit", month: "2-digit", year: "numeric" })}
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 flex-wrap">
                            <div className="flex flex-col items-center px-5 py-2.5 rounded-xl bg-primary/5 border border-primary/10 min-w-[80px]">
                                <span className="text-xs text-muted-foreground font-semibold uppercase tracking-wider">Total Qty</span>
                                <span className="text-2xl font-bold text-primary">{detail.total_quantity}</span>
                            </div>
                ...
                <div className="lg:col-span-2">
                    <Card className="shadow-sm border-border/50 bg-card/60 backdrop-blur-md">
                        <CardHeader className="flex flex-row items-center gap-2 border-b border-border/50 py-3 px-4">
                            ...
                            <CardTitle className="text-sm font-semibold text-primary">Adjustment Items</CardTitle>
                        </CardHeader>
                        <CardContent className="p-0">
                            <div className="overflow-x-auto [&_[data-slot=table-container]]:overflow-visible">
                                <Table className="whitespace-nowrap">
                                    <TableHeader className="bg-sidebar-accent border-b border-border/50">
                                        <TableRow>
                                            ...
                                            <TableHead className="px-4 h-10 text-xs font-semibold">Location</TableHead>
                                            <TableHead className="px-4 h-10 text-xs font-semibold text-center">Type</TableHead>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="p-3 rounded-xl bg-muted/30 border border-border/50 text-center">
                        <p className="text-xs text-muted-foreground italic leading-relaxed">
                            {isCompleted ? "Phiếu đã hoàn tất và không thể chỉnh sửa." : "Phiếu đang được xử lý."}
                        </p>
                    </div>
                </div>
            </div>
