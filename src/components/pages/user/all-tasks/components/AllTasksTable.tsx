...
export default function AllTasksTable({
  ...
  const [activeTableTab, setActiveTableTab] = useState<"requests" | "audits">("requests");
    ...
    <div className="w-full h-full flex flex-col min-h-0 gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 flex-1 lg:justify-end">
          ...
          >
            ...
            <Input
              ...
              className="pl-8 h-8.5 w-full sm:w-[200px] md:w-[260px] bg-background/5 border-border/60 text-xs"
            />
          </form>
          ...
          {auditType === "all" && (
            ...
            >
              <SelectTrigger className="w-[140px] h-8.5 text-xs border-border/60 bg-background/5">
      ...
      {isWorkflowPending || isAuditPending ? (
        ...
        workflowTasks.length === 0 ? (
          <div className="grow flex flex-col items-center justify-center min-h-[300px] bg-card/20 rounded-xl border border-dashed border-border/60 p-8 text-center">
