...
export default function AllocationRecoveryDetail({ id }: Props) {
  ...
  return (
    <div className="flex flex-col px-3 pb-3 gap-3 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Workflow History */}
      <Card className="shadow-sm border-border/50 bg-card/60 backdrop-blur-md overflow-hidden">
        <CardHeader className="flex flex-row items-center gap-2 border-b border-border/50 py-3 px-4 shrink-0">
                  ...
                  >
                    ...
                    <TableCell className="px-4 py-1.5 text-center">
                      <Badge
                        variant="outline"
                        className={cn(
                          "px-2.5 py-1 rounded-full text-xs font-bold shadow-none",
