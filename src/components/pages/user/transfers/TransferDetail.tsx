            ...
            <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col gap-0.5">
                        <h1 className="text-lg font-semibold text-foreground">Transfer Detail</h1>
                        <span className="text-xs text-muted-foreground">Transfer Management</span>
                    </div>
                </div>
            </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex flex-col gap-0.5">
                                ...
                                <span className="text-xs text-muted-foreground">
                                    Type: {detail.transfer_type.charAt(0).toUpperCase() + detail.transfer_type.slice(1)}
                                </span>
                            </div>
                        </div>
                ...
                <div className="lg:col-span-2">
                    <Card className="shadow-sm border-border/50 bg-card/60 backdrop-blur-md h-full flex flex-col">
                        <CardHeader className="flex flex-row items-center gap-2 border-b border-border/50 py-3 px-4 shrink-0">
                            ...
                            <CardTitle className="text-sm font-semibold text-primary">Transferred Items</CardTitle>
                        </CardHeader>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <Card className="shadow-sm border-border/50 bg-card/60 backdrop-blur-md">
                        <CardHeader className="flex flex-row items-center gap-2 border-b border-border/50 py-3 px-4">
                            ...
                            <CardTitle className="text-sm font-semibold text-primary">Transfer Information</CardTitle>
                        </CardHeader>
                        <CardContent className="p-4 flex flex-col gap-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2 text-muted-foreground">
                                    <Calendar size={15} />
                                    <span className="text-xs font-semibold uppercase tracking-wider">Transfer Date</span>
                                </div>
                                <span className="text-sm font-semibold text-foreground">
                                    {new Date(detail.transfer_date).toLocaleDateString("vi-VN")}
                                </span>
                            </div>
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2 text-muted-foreground">
                                ...
                                <span className="text-sm font-semibold text-foreground">{detail.transfer_type}</span>
                            </div>
                            ...
                            <div className="flex flex-col gap-1.5 pt-2 border-t border-border/50">
                                ...
                                <p className="text-sm text-foreground/80 leading-relaxed italic">{detail.reason || "No reason provided."}</p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="shadow-sm border-border/50 bg-card/60 backdrop-blur-md">
                        <CardHeader className="flex flex-row items-center gap-2 border-b border-border/50 py-3 px-4">
                            ...
                            <CardTitle className="text-sm font-semibold text-primary">Route Information</CardTitle>
                        </CardHeader>
                        <CardContent className="p-4 flex flex-col gap-4">
                            <div className="flex flex-col gap-1">
