      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <Field>
            ...
            <Textarea {...field} className="min-h-[100px] bg-white" placeholder="Why is this asset being maintained?" />
            <FieldError errors={[fieldState.error]} />
          </Field>
        )}
      />
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <Field>
            ...
            <Textarea {...field} value={field.value || ""} className="min-h-[80px] bg-white" placeholder="Additional notes..." />
            <FieldError errors={[fieldState.error]} />
          </Field>
        )}
      />
