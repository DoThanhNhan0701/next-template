...
import { Contact, EditIcon, Search } from "lucide-react";
        ...
        <Table className="w-full">
          <TableHeader className="bg-sidebar-accent text-foreground border-b border-(--surface-border-color) sticky top-0 z-10 shadow-sm">
            <TableRow>
              ...
              <TableHead className="font-semibold h-10 px-4 hidden sm:table-cell">
                {t("staff_code")}
              </TableHead>
            ...
            {pending && staffs.length === 0 ? (
              ...
              staffs.map((staff, index) => (
                ...
                >
                  ...
                  <TableCell className="px-4 py-1.5 font-medium text-foreground hidden sm:table-cell">
                    {staff.staff_code}
                  </TableCell>
