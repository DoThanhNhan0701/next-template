...
export const GetMaintenanceSchema = (t: TFunction) =>
  z
    .object({
      ...
      service_provider_name: z.string().min(1, t("validation.field_required")),
      ...
      outing_date: z.string().min(1, t("validation.field_required")),
      items: z
        .array(
          z.object({
...
export type MaintenanceFormValues = z.infer<
  ReturnType<typeof GetMaintenanceSchema>
>;
